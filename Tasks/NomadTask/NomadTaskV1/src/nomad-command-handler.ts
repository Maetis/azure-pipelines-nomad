...
import {NomadAuthorizationCommandInitializer} from './nomad-commands';
import {BaseNomadCommandHandler} from './base-nomad-command-handler';

export class NomadCommandHandler extends BaseNomadCommandHandler {
    constructor() {
        super();
    ...
    public handleProvider(command: NomadAuthorizationCommandInitializer) {
